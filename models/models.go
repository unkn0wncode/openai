...
var Data = map[string]struct {
	...
	GPT4:                        {0.00003000, 0.00006000, 8192, 4096},
	"gpt-4-0613":                {0.00003000, 0.00006000, 8192, 8192},
	GPT4Vision:                  {0.00003000, 0.00006000, 128000, 4096},
	"gpt-4-1106-vision-preview": {0.00001000, 0.00003000, 128000, 4096},
	GPT4TurboPreview:            {0.00001000, 0.00003000, 128000, 4096},
	GPT4Turbo:                   {0.00001000, 0.00003000, 128000, 4096},
	GPT4Turbo0125:               {0.00001000, 0.00003000, 128000, 4096},
	GPT4Turbo20240409:           {0.00001000, 0.00003000, 128000, 4096},
	GPT432k:                     {0.00006000, 0.00012000, 32000, 32768},
	GPT4Omni:                    {0.00000500, 0.00001500, 128000, 4096},
	GPT4Omni20240513:            {0.00000500, 0.00001500, 128000, 4096},
	GPT4Omni20240806:            {0.00000500, 0.00001500, 128000, 16348},
	GPT4Omni20241120:            {0.00000500, 0.00001500, 128000, 16348},
	GPT4oMini:                   {0.00000015, 0.00000060, 128000, 16348},
	GPT4oMini20240718:           {0.00000015, 0.00000060, 128000, 16348},
	GPT4QuasarMini:              {0.00000040, 0.00000160, 1000000, 32768},
	GPT4QuasarNano:              {0.00000010, 0.00000040, 1000000, 32768},
	GPT4Quasar:                  {0.00000200, 0.00000800, 1000000, 32768},
	GPT4oLatest:                 {0.00000500, 0.00001500, 128000, 4096},
	"gpt-4-0613-32k":            {0.00006000, 0.00012000, 32000, 32768},
	GPT45:                       {0.00006000, 0.00018000, 8192, 4096},  // unconfirmed
	GPT4564k:                    {0.00012000, 0.00036000, 64000, 4096}, // unconfirmed
	GPT:                         {0.00000050, 0.00000150, 16348, 4096},
	GPTO1:                       {0.00001500, 0.00006000, 200000, 100000},
	GPTO120241217:               {0.00001500, 0.00006000, 200000, 100000},
	GPTO1Mini:                   {0.00000300, 0.00001200, 128000, 65536},
	GPTO1Mini20240912:           {0.00000300, 0.00001200, 128000, 65536},
	GPTO1Preview:                {0.00001500, 0.00006000, 128000, 32768},
	GPTO1Preview20240912:        {0.00001500, 0.00006000, 128000, 32768},
	GPTO3Mini:                   {0.00000110, 0.00000440, 200000, 100000},
	GPTO3Mini20250131:           {0.00000110, 0.00000440, 200000, 100000},
